  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
      <ul class="nav navbar-nav">
        <li><a href="/anuncios/listar">Todos os Anúncios</a></li>
      </ul>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown closed">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="true">Ações<span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><!-- class="active" --><a href="/usuario/formCadastro">Cadastre-se</a></li>
        	<li><a href="/usuario/login">Faça seu Login</a></li>
          </ul>
        </li>
      </ul>
    </div>
